...
<head>
    ...
    <![endif]-->       
    <link rel="shortcut icon" href="{{URL::to('front/images/ico/favicon.ico')}}">
    ...
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="{{URL::to('front/images/ico/apple-touch-icon-72-precomposed.png')}}">
                ...
                <div class="col-sm-12">
                    <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <?php
                            $all_slider=DB::table('tbl_slider')->where('publication_status',1)->limit(3)->get();
                            $i=0;
                            ?>
                            ...
                            <div class="item <?php if($i==1) { echo 'active';} else{echo '';} ?>">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <img src="{{URL::to('front/images/home/pricing.png')}}"  class="pricing" alt="" />
                                </div>
                            </div>
                                <?php $i++ ?>
                ...
                <div class="col-sm-3">
                    <div class="left-sidebar">
                        ...
                        <div class="panel-group category-products" id="accordian"><!--category-productsr-->
                            <?php $all_category=DB::table('tbl_category')->where('publication_status',1)->get() ?>
                            @foreach($all_category as $value)
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title"><a href="{{URL::to('product_by_category/'.$value->category_id)}}">{{$value->category_name}}</a></h4>
                                </div>
                            </div>
                            @endforeach
                        ...
                        <div class="brands_products"><!--brands_products-->
                            <h2>Brands</h2>
                            <?php $all_menufecture=DB::table('tbl_menufecture')->where('publication_status',1)->get()?>
                            <div class="brands-name">

                                <ul class="nav nav-pills nav-stacked">
                                     @foreach($all_menufecture as $menufecture)
                                    <li><a href="{{URL::to('product_by_menufecture/'.$menufecture->menufecture_id)}}"> <span class="pull-right">(50)</span>{{$menufecture->menufecture_name}}</a></li>
                                    @endforeach
