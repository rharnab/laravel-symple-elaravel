	...
	<div class="container">
		...
		<div class="paymentCont col-sm-8">
					...
					<form action="{{URl('order-place')}}" method="post">
						{{csrf_field()}}
						<input type="radio" name="payment_method" value="handcash"> HnadCash <br>
						<input type="radio" name="payment_method" value="Debit">Debot <br>
						<input type="radio" name="payment_method" value="BCash"> BCash <br>
