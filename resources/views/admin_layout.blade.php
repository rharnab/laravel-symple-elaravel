			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						<li><a href="{{URL::to('/deshboard')}}"><i class="icon-bar-chart"></i><span class="hidden-tablet"> Dashboard</span></a></li>
						...
						<li><a href="{{URL::to('all-menufecture')}}"><i class="icon-eye-open"></i><span class="hidden-tablet"> All Menufecture</span></a></li>

						<li><a href="{{URL::to('add-menufecture')}}"><i class="icon-dashboard"></i><span class="hidden-tablet">Add Menufecture</span></a></li>
						<li>
						...
						<li><a href="{{'/manage-order'}}"><i class="icon-list-alt"></i><span class="hidden-tablet"> Manage Order</span></a></li>
